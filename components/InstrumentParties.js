...
var InstrumentPartyRoleQualifier = require('../fields/InstrumentPartyRoleQualifier');
...
/* field */
InstrumentParties.prototype.instrumentPartyRoleQualifier = function () {
  return new InstrumentPartyRoleQualifier(this.message.tags[InstrumentPartyRoleQualifier.Tag]);
};
