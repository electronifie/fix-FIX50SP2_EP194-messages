...
var InformationBarrierID = require('../fields/InformationBarrierID');
...
/* field */
TrdRegTimestamps.prototype.informationBarrierId = function () {
  return new InformationBarrierID(this.message.tags[InformationBarrierID.Tag]);
};
