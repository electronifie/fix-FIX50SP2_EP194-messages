...
/* field */
SideCrossOrdCxlGrp.prototype.complianceText = function () {
  return new ComplianceText(this.message.tags[ComplianceText.Tag]);
};

/* field */
SideCrossOrdCxlGrp.prototype.encodedComplianceTextLen = function () {
  return new EncodedComplianceTextLen(this.message.tags[EncodedComplianceTextLen.Tag]);
};

/* field */
SideCrossOrdCxlGrp.prototype.encodedComplianceText = function () {
