...
/* field */
TrdSessLstGrp.prototype.tradSesUpdateAction = function () {
  return new TradSesUpdateAction(this.message.tags[TradSesUpdateAction.Tag]);
};
...
/* field */
TrdSessLstGrp.prototype.transactTime = function () {
