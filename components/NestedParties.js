...
var NestedPartyRoleQualifier = require('../fields/NestedPartyRoleQualifier');
...
/* field */
NestedParties.prototype.nestedPartyRoleQualifier = function () {
  return new NestedPartyRoleQualifier(this.message.tags[NestedPartyRoleQualifier.Tag]);
};
