...
var SettlPartyRoleQualifier = require('../fields/SettlPartyRoleQualifier');
...
/* field */
SettlParties.prototype.settlPartyRoleQualifier = function () {
  return new SettlPartyRoleQualifier(this.message.tags[SettlPartyRoleQualifier.Tag]);
};
