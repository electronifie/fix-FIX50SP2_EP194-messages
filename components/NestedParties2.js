...
var Nested2PartyRoleQualifier = require('../fields/Nested2PartyRoleQualifier');
...
/* field */
NestedParties2.prototype.nested2PartyRoleQualifier = function () {
  return new Nested2PartyRoleQualifier(this.message.tags[Nested2PartyRoleQualifier.Tag]);
};
