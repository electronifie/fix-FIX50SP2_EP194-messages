...
/* field */
ListOrdGrp.prototype.shortMarkingExemptIndicator = function () {
  return new ShortMarkingExemptIndicator(this.message.tags[ShortMarkingExemptIndicator.Tag]);
};

/* field */
ListOrdGrp.prototype.shortSaleExemptionReason = function () {
  return new ShortSaleExemptionReason(this.message.tags[ShortSaleExemptionReason.Tag]);
};
...
/* field */
ListOrdGrp.prototype.complianceText = function () {
  return new ComplianceText(this.message.tags[ComplianceText.Tag]);
};

/* field */
ListOrdGrp.prototype.encodedComplianceTextLen = function () {
  return new EncodedComplianceTextLen(this.message.tags[EncodedComplianceTextLen.Tag]);
};

/* field */
ListOrdGrp.prototype.encodedComplianceText = function () {
...
/* field */
ListOrdGrp.prototype.exposureDuration = function () {
  return new ExposureDuration(this.message.tags[ExposureDuration.Tag]);
};

/* field */
ListOrdGrp.prototype.exposureDurationUnit = function () {
...
/* field */
ListOrdGrp.prototype.manualOrderIndicator = function () {
  return new ManualOrderIndicator(this.message.tags[ManualOrderIndicator.Tag]);
};
