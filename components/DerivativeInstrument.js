...
var DerivativeContractMultiplierUnit = require('../fields/DerivativeContractMultiplierUnit');
var DerivativeFlowScheduleType = require('../fields/DerivativeFlowScheduleType');
...
var DerivativeUnitOfMeasureCurrency = require('../fields/DerivativeUnitOfMeasureCurrency');
...
var DerivativePriceUnitOfMeasureCurrency = require('../fields/DerivativePriceUnitOfMeasureCurrency');
...
var DerivativeValuationMethod = require('../fields/DerivativeValuationMethod');
var DerivativePriceQuoteCurrency = require('../fields/DerivativePriceQuoteCurrency');
...
/* field */
DerivativeInstrument.prototype.derivativeContractMultiplierUnit = function () {
  return new DerivativeContractMultiplierUnit(this.message.tags[DerivativeContractMultiplierUnit.Tag]);
};

/* field */
DerivativeInstrument.prototype.derivativeFlowScheduleType = function () {
  return new DerivativeFlowScheduleType(this.message.tags[DerivativeFlowScheduleType.Tag]);
};
...
/* field */
DerivativeInstrument.prototype.derivativeUnitOfMeasureCurrency = function () {
  return new DerivativeUnitOfMeasureCurrency(this.message.tags[DerivativeUnitOfMeasureCurrency.Tag]);
};
...
/* field */
DerivativeInstrument.prototype.derivativePriceUnitOfMeasureCurrency = function () {
  return new DerivativePriceUnitOfMeasureCurrency(this.message.tags[DerivativePriceUnitOfMeasureCurrency.Tag]);
};
...
/* field */
DerivativeInstrument.prototype.derivativeValuationMethod = function () {
  return new DerivativeValuationMethod(this.message.tags[DerivativeValuationMethod.Tag]);
};

/* field */
DerivativeInstrument.prototype.derivativePriceQuoteCurrency = function () {
  return new DerivativePriceQuoteCurrency(this.message.tags[DerivativePriceQuoteCurrency.Tag]);
};
