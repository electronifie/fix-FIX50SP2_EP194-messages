...
var TradeVolType = require('../fields/TradeVolType');
...
/* field */
BaseTradingRules.prototype.tradeVolType = function () {
  return new TradeVolType(this.message.tags[TradeVolType.Tag]);
};
