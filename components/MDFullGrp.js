...
/* component */
MDFullGrp.prototype.rateSource = function () {
...
/* component */
MDFullGrp.prototype.tradePriceConditionGrp = function () {
...
/* component */
MDFullGrp.prototype.relatedTradeGrp = function () {
...
/* field */
MDFullGrp.prototype.settlCurrency = function () {
...
/* field */
MDFullGrp.prototype.haltReason = function () {
  return new HaltReason(this.message.tags[HaltReason.Tag]);
};

/* field */
MDFullGrp.prototype.fastMarketIndicator = function () {
...
/* field */
MDFullGrp.prototype.exposureDuration = function () {
  return new ExposureDuration(this.message.tags[ExposureDuration.Tag]);
};

/* field */
MDFullGrp.prototype.exposureDurationUnit = function () {
...
/* field */
MDFullGrp.prototype.numberOfBuyOrders = function () {
  return new NumberOfBuyOrders(this.message.tags[NumberOfBuyOrders.Tag]);
};

/* field */
MDFullGrp.prototype.numberOfSellOrders = function () {
...
/* field */
MDFullGrp.prototype.firstPx = function () {
  return new FirstPx(this.message.tags[FirstPx.Tag]);
};

/* field */
MDFullGrp.prototype.lastPx = function () {
  return new LastPx(this.message.tags[LastPx.Tag]);
};

/* field */
MDFullGrp.prototype.discountFactor = function () {
...
/* field */
MDFullGrp.prototype.settlPriceDeterminationMethod = function () {
...
/* field */
MDFullGrp.prototype.aggressorTime = function () {
  return new AggressorTime(this.message.tags[AggressorTime.Tag]);
};

/* field */
MDFullGrp.prototype.aggressorSide = function () {
