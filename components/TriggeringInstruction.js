...
var TriggerScope = require('../fields/TriggerScope');
...
/* field */
TriggeringInstruction.prototype.triggerScope = function () {
  return new TriggerScope(this.message.tags[TriggerScope.Tag]);
};
