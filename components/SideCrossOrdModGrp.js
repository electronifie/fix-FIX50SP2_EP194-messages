...
var SideCrossLegGrp = require('../components/SideCrossLegGrp');
...
/* component */
SideCrossOrdModGrp.prototype.sideCrossLegGrp = function () {
  return this.message.groups[SideCrossLegGrp.Tag]
    .map(function (sideCrossLegGrp) {
      return new SideCrossLegGrp(sideCrossLegGrp);
  });
};
...
/* field */
SideCrossOrdModGrp.prototype.shortMarkingExemptIndicator = function () {
...
/* field */
SideCrossOrdModGrp.prototype.sideShortSaleExemptionReason = function () {
...
/* field */
SideCrossOrdModGrp.prototype.clearingAccountType = function () {
