...
var Nested3PartyRoleQualifier = require('../fields/Nested3PartyRoleQualifier');
...
/* field */
NestedParties3.prototype.nested3PartyRoleQualifier = function () {
  return new Nested3PartyRoleQualifier(this.message.tags[Nested3PartyRoleQualifier.Tag]);
};
