...
/* field */
QuotEntryGrp.prototype.totalBidSize = function () {
  return new TotalBidSize(this.message.tags[TotalBidSize.Tag]);
};

/* field */
QuotEntryGrp.prototype.totalOfferSize = function () {
  return new TotalOfferSize(this.message.tags[TotalOfferSize.Tag]);
};
...
/* field */
QuotEntryGrp.prototype.bookingType = function () {
  return new BookingType(this.message.tags[BookingType.Tag]);
};

/* field */
QuotEntryGrp.prototype.orderCapacity = function () {
  return new OrderCapacity(this.message.tags[OrderCapacity.Tag]);
};

/* field */
QuotEntryGrp.prototype.orderRestrictions = function () {
