...
var PartyRoleQualifier = require('../fields/PartyRoleQualifier');
...
/* field */
Parties.prototype.partyRoleQualifier = function () {
  return new PartyRoleQualifier(this.message.tags[PartyRoleQualifier.Tag]);
};
