...
var WireReference = require('../fields/WireReference');
var TradeDate = require('../fields/TradeDate');
var TransactionID = require('../fields/TransactionID');
var FirmTransactionID = require('../fields/FirmTransactionID');
var CollateralRequestLinkID = require('../fields/CollateralRequestLinkID');
var TotNumCollateralRequests = require('../fields/TotNumCollateralRequests');
var CollateralRequestNumber = require('../fields/CollateralRequestNumber');
var CollateralRequestInstruction = require('../fields/CollateralRequestInstruction');
var Text = require('../fields/Text');
var EncodedTextLen = require('../fields/EncodedTextLen');
var EncodedText = require('../fields/EncodedText');
var WarningText = require('../fields/WarningText');
var EncodedWarningTextLen = require('../fields/EncodedWarningTextLen');
var EncodedWarningText = require('../fields/EncodedWarningText');
...
CollateralResponse.prototype.wireReference = function () {
  return new WireReference(this.message.tags[CollateralResponse.Tags.WireReference]);
};

CollateralResponse.prototype.tradeDate = function () {
  return new TradeDate(this.message.tags[CollateralResponse.Tags.TradeDate]);
};

CollateralResponse.prototype.transactionId = function () {
  return new TransactionID(this.message.tags[CollateralResponse.Tags.TransactionID]);
};

CollateralResponse.prototype.firmTransactionId = function () {
  return new FirmTransactionID(this.message.tags[CollateralResponse.Tags.FirmTransactionID]);
};

CollateralResponse.prototype.collateralRequestLinkId = function () {
  return new CollateralRequestLinkID(this.message.tags[CollateralResponse.Tags.CollateralRequestLinkID]);
};

CollateralResponse.prototype.totNumCollateralRequests = function () {
  return new TotNumCollateralRequests(this.message.tags[CollateralResponse.Tags.TotNumCollateralRequests]);
};

CollateralResponse.prototype.collateralRequestNumber = function () {
  return new CollateralRequestNumber(this.message.tags[CollateralResponse.Tags.CollateralRequestNumber]);
};

CollateralResponse.prototype.collateralRequestInstruction = function () {
  return new CollateralRequestInstruction(this.message.tags[CollateralResponse.Tags.CollateralRequestInstruction]);
};
...
CollateralResponse.prototype.warningText = function () {
  return new WarningText(this.message.tags[CollateralResponse.Tags.WarningText]);
};

CollateralResponse.prototype.encodedWarningTextLen = function () {
  return new EncodedWarningTextLen(this.message.tags[CollateralResponse.Tags.EncodedWarningTextLen]);
};

CollateralResponse.prototype.encodedWarningText = function () {
  return new EncodedWarningText(this.message.tags[CollateralResponse.Tags.EncodedWarningText]);
};

CollateralResponse.prototype.rejectText = function () {
  return new RejectText(this.message.tags[CollateralResponse.Tags.RejectText]);
};

CollateralResponse.prototype.encodedRejectTextLen = function () {
  return new EncodedRejectTextLen(this.message.tags[CollateralResponse.Tags.EncodedRejectTextLen]);
};

CollateralResponse.prototype.encodedRejectText = function () {
  return new EncodedRejectText(this.message.tags[CollateralResponse.Tags.EncodedRejectText]);
};
