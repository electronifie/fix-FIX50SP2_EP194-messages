...
AssignmentReport.prototype.posReqId = function () {
  return new PosReqID(this.message.tags[AssignmentReport.Tags.PosReqID]);
};
...
AssignmentReport.prototype.positionContingentPrice = function () {
  return new PositionContingentPrice(this.message.tags[AssignmentReport.Tags.PositionContingentPrice]);
};
