...
var AllocReversalStatus = require('../fields/AllocReversalStatus');
...
var AllocGroupQuantity = require('../fields/AllocGroupQuantity');
var AllocGroupRemainingQuantity = require('../fields/AllocGroupRemainingQuantity');
...
AllocationReport.prototype.allocGroupId = function () {
  return new AllocGroupID(this.message.tags[AllocationReport.Tags.AllocGroupID]);
};

AllocationReport.prototype.firmGroupId = function () {
  return new FirmGroupID(this.message.tags[AllocationReport.Tags.FirmGroupID]);
};
...
AllocationReport.prototype.allocReversalStatus = function () {
  return new AllocReversalStatus(this.message.tags[AllocationReport.Tags.AllocReversalStatus]);
};
...
AllocationReport.prototype.avgPxGroupId = function () {
  return new AvgPxGroupID(this.message.tags[AllocationReport.Tags.AvgPxGroupID]);
};
...
AllocationReport.prototype.allocGroupQuantity = function () {
  return new AllocGroupQuantity(this.message.tags[AllocationReport.Tags.AllocGroupQuantity]);
};

AllocationReport.prototype.allocGroupRemainingQuantity = function () {
  return new AllocGroupRemainingQuantity(this.message.tags[AllocationReport.Tags.AllocGroupRemainingQuantity]);
};
...
AllocationReport.prototype.custOrderHandlingInst = function () {
  return new CustOrderHandlingInst(this.message.tags[AllocationReport.Tags.CustOrderHandlingInst]);
};

AllocationReport.prototype.orderHandlingInstSource = function () {
  return new OrderHandlingInstSource(this.message.tags[AllocationReport.Tags.OrderHandlingInstSource]);
};
...
AllocationReport.prototype.venueType = function () {
  return new VenueType(this.message.tags[AllocationReport.Tags.VenueType]);
};

AllocationReport.prototype.refRiskLimitCheckId = function () {
  return new RefRiskLimitCheckID(this.message.tags[AllocationReport.Tags.RefRiskLimitCheckID]);
};

AllocationReport.prototype.refRiskLimitCheckIdtype = function () {
  return new RefRiskLimitCheckIDType(this.message.tags[AllocationReport.Tags.RefRiskLimitCheckIDType]);
};

AllocationReport.prototype.riskLimitCheckStatus = function () {
  return new RiskLimitCheckStatus(this.message.tags[AllocationReport.Tags.RiskLimitCheckStatus]);
};
