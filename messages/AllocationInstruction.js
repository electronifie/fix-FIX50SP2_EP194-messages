...
AllocationInstruction.prototype.regulatoryTradeIdgrp = function () {
  if (this.message.groups === undefined) return null;
  if (this.message.groups[AllocationInstruction.Tags.RegulatoryTradeIDGrp] === undefined) return null;
  return this.message.groups[AllocationInstruction.Tags.RegulatoryTradeIDGrp]
...
AllocationInstruction.prototype.rateSource = function () {
  if (this.message.groups === undefined) return null;
  if (this.message.groups[AllocationInstruction.Tags.RateSource] === undefined) return null;
  return this.message.groups[AllocationInstruction.Tags.RateSource]
...
AllocationInstruction.prototype.allocGroupId = function () {
  return new AllocGroupID(this.message.tags[AllocationInstruction.Tags.AllocGroupID]);
};

AllocationInstruction.prototype.firmGroupId = function () {
  return new FirmGroupID(this.message.tags[AllocationInstruction.Tags.FirmGroupID]);
};
...
AllocationInstruction.prototype.avgPxGroupId = function () {
  return new AvgPxGroupID(this.message.tags[AllocationInstruction.Tags.AvgPxGroupID]);
};
...
AllocationInstruction.prototype.venueType = function () {
  return new VenueType(this.message.tags[AllocationInstruction.Tags.VenueType]);
};

AllocationInstruction.prototype.refRiskLimitCheckId = function () {
  return new RefRiskLimitCheckID(this.message.tags[AllocationInstruction.Tags.RefRiskLimitCheckID]);
};

AllocationInstruction.prototype.refRiskLimitCheckIdtype = function () {
  return new RefRiskLimitCheckIDType(this.message.tags[AllocationInstruction.Tags.RefRiskLimitCheckIDType]);
};

AllocationInstruction.prototype.riskLimitCheckStatus = function () {
  return new RiskLimitCheckStatus(this.message.tags[AllocationInstruction.Tags.RiskLimitCheckStatus]);
};
