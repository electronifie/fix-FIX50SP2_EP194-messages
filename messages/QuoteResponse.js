...
QuoteResponse.prototype.quoteReqId = function () {
  return new QuoteReqID(this.message.tags[QuoteResponse.Tags.QuoteReqID]);
};
...
QuoteResponse.prototype.trdType = function () {
  return new TrdType(this.message.tags[QuoteResponse.Tags.TrdType]);
};

QuoteResponse.prototype.regulatoryTransactionType = function () {
  return new RegulatoryTransactionType(this.message.tags[QuoteResponse.Tags.RegulatoryTransactionType]);
};

QuoteResponse.prototype.negotiationMethod = function () {
  return new NegotiationMethod(this.message.tags[QuoteResponse.Tags.NegotiationMethod]);
};
...
QuoteResponse.prototype.coverPrice = function () {
  return new CoverPrice(this.message.tags[QuoteResponse.Tags.CoverPrice]);
};
