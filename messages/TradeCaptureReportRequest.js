...
TradeCaptureReportRequest.prototype.secondaryExecId = function () {
  return new SecondaryExecID(this.message.tags[TradeCaptureReportRequest.Tags.SecondaryExecID]);
};
...
TradeCaptureReportRequest.prototype.offsetInstruction = function () {
  return new OffsetInstruction(this.message.tags[TradeCaptureReportRequest.Tags.OffsetInstruction]);
};
