...
OrderCancelRequest.prototype.orderRequestId = function () {
  return new OrderRequestID(this.message.tags[OrderCancelRequest.Tags.OrderRequestID]);
};
...
OrderCancelRequest.prototype.marketSegmentId = function () {
  return new MarketSegmentID(this.message.tags[OrderCancelRequest.Tags.MarketSegmentID]);
};

OrderCancelRequest.prototype.exDestination = function () {
  return new ExDestination(this.message.tags[OrderCancelRequest.Tags.ExDestination]);
};

OrderCancelRequest.prototype.exDestinationIdsource = function () {
  return new ExDestinationIDSource(this.message.tags[OrderCancelRequest.Tags.ExDestinationIDSource]);
};
...
OrderCancelRequest.prototype.complianceText = function () {
  return new ComplianceText(this.message.tags[OrderCancelRequest.Tags.ComplianceText]);
};

OrderCancelRequest.prototype.encodedComplianceTextLen = function () {
  return new EncodedComplianceTextLen(this.message.tags[OrderCancelRequest.Tags.EncodedComplianceTextLen]);
};

OrderCancelRequest.prototype.encodedComplianceText = function () {
  return new EncodedComplianceText(this.message.tags[OrderCancelRequest.Tags.EncodedComplianceText]);
};
