...
CollateralAssignment.prototype.wireReference = function () {
  return new WireReference(this.message.tags[CollateralAssignment.Tags.WireReference]);
};

CollateralAssignment.prototype.tradeDate = function () {
  return new TradeDate(this.message.tags[CollateralAssignment.Tags.TradeDate]);
};

CollateralAssignment.prototype.transactionId = function () {
  return new TransactionID(this.message.tags[CollateralAssignment.Tags.TransactionID]);
};

CollateralAssignment.prototype.firmTransactionId = function () {
  return new FirmTransactionID(this.message.tags[CollateralAssignment.Tags.FirmTransactionID]);
};
...
CollateralAssignment.prototype.collateralRequestLinkId = function () {
  return new CollateralRequestLinkID(this.message.tags[CollateralAssignment.Tags.CollateralRequestLinkID]);
};

CollateralAssignment.prototype.totNumCollateralRequests = function () {
  return new TotNumCollateralRequests(this.message.tags[CollateralAssignment.Tags.TotNumCollateralRequests]);
};

CollateralAssignment.prototype.collateralRequestNumber = function () {
  return new CollateralRequestNumber(this.message.tags[CollateralAssignment.Tags.CollateralRequestNumber]);
};

CollateralAssignment.prototype.collateralRequestInstruction = function () {
  return new CollateralRequestInstruction(this.message.tags[CollateralAssignment.Tags.CollateralRequestInstruction]);
};
