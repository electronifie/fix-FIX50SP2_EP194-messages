...
AllocationInstructionAlert.prototype.allocGroupId = function () {
  return new AllocGroupID(this.message.tags[AllocationInstructionAlert.Tags.AllocGroupID]);
};

AllocationInstructionAlert.prototype.firmGroupId = function () {
  return new FirmGroupID(this.message.tags[AllocationInstructionAlert.Tags.FirmGroupID]);
};
...
AllocationInstructionAlert.prototype.allocGroupQuantity = function () {
  return new AllocGroupQuantity(this.message.tags[AllocationInstructionAlert.Tags.AllocGroupQuantity]);
};

AllocationInstructionAlert.prototype.allocGroupRemainingQuantity = function () {
  return new AllocGroupRemainingQuantity(this.message.tags[AllocationInstructionAlert.Tags.AllocGroupRemainingQuantity]);
};
...
AllocationInstructionAlert.prototype.allocStatus = function () {
  return new AllocStatus(this.message.tags[AllocationInstructionAlert.Tags.AllocStatus]);
};
...
AllocationInstructionAlert.prototype.avgPxGroupId = function () {
  return new AvgPxGroupID(this.message.tags[AllocationInstructionAlert.Tags.AvgPxGroupID]);
};
...
AllocationInstructionAlert.prototype.custOrderHandlingInst = function () {
  return new CustOrderHandlingInst(this.message.tags[AllocationInstructionAlert.Tags.CustOrderHandlingInst]);
};

AllocationInstructionAlert.prototype.orderHandlingInstSource = function () {
  return new OrderHandlingInstSource(this.message.tags[AllocationInstructionAlert.Tags.OrderHandlingInstSource]);
};
