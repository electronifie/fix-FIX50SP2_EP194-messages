...
NewOrderCross.prototype.orderRequestId = function () {
  return new OrderRequestID(this.message.tags[NewOrderCross.Tags.OrderRequestID]);
};
...
NewOrderCross.prototype.minQtyMethod = function () {
  return new MinQtyMethod(this.message.tags[NewOrderCross.Tags.MinQtyMethod]);
};
...
NewOrderCross.prototype.marketSegmentId = function () {
  return new MarketSegmentID(this.message.tags[NewOrderCross.Tags.MarketSegmentID]);
};
...
NewOrderCross.prototype.exposureDuration = function () {
  return new ExposureDuration(this.message.tags[NewOrderCross.Tags.ExposureDuration]);
};

NewOrderCross.prototype.exposureDurationUnit = function () {
  return new ExposureDurationUnit(this.message.tags[NewOrderCross.Tags.ExposureDurationUnit]);
};

NewOrderCross.prototype.tradingCapacity = function () {
  return new TradingCapacity(this.message.tags[NewOrderCross.Tags.TradingCapacity]);
};
...
NewOrderCross.prototype.throttleInst = function () {
  return new ThrottleInst(this.message.tags[NewOrderCross.Tags.ThrottleInst]);
};
