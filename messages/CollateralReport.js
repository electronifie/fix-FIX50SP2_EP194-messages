...
CollateralReport.prototype.wireReference = function () {
  return new WireReference(this.message.tags[CollateralReport.Tags.WireReference]);
};

CollateralReport.prototype.tradeDate = function () {
  return new TradeDate(this.message.tags[CollateralReport.Tags.TradeDate]);
};

CollateralReport.prototype.transactionId = function () {
  return new TransactionID(this.message.tags[CollateralReport.Tags.TransactionID]);
};

CollateralReport.prototype.firmTransactionId = function () {
  return new FirmTransactionID(this.message.tags[CollateralReport.Tags.FirmTransactionID]);
};
