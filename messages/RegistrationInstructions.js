...
RegistrationInstructions.prototype.clearingBusinessDate = function () {
  return new ClearingBusinessDate(this.message.tags[RegistrationInstructions.Tags.ClearingBusinessDate]);
};
