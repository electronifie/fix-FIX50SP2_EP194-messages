...
TradeCondition.Keys = {
  ...
  BASKET_INDEX: 'AS',
  BURST_BASKET: 'AT',
  TRADE_THROUGH_EXEMPT: 'AU',
  QUOTE_SPREAD: 'AV',
  LAST_AUCTION_PRICE: 'AW',
  HIGH_PRICE: 'AX',
  LOW_PRICE: 'AY',
  SYSTEMATIC_INTERNALIZER: 'AZ',
  AWAY_MARKET: 'BA',
  MID_POINT_PRICE: 'BB',
  TRADED_BEFORE_ISSUE_DATE: 'BC',
  PREVIOUS_CLOSING_PRICE: 'BD',
  NATIONAL_BEST_BID_AND_OFFER: 'BE',
  IMPLIED_TRADE: '1',
  MARKETPLACE_ENTERED_TRADE: '2',
  MULT_ASSET_CLASS_MULTILEG_TRADE: '3',
  MULTILEG_TO_MULTILEG_TRADE: '4',
  SHORT_SALE_MINIMUM_PRICE: '5',
  BENCHMARK: '6',
};
